...
st.write("Upload any file safely without system crash.")
...
if uploaded_file is not None:
    try:
        ...
        # 1. Read only first 100 rows for lightning-fast Preview
        ...
        # 2. Calculate total rows in chunks so Large Files don't crash RAM
        total_rows = 0
        ...
        # 3. Show Preview of Data (Only the clean table)
